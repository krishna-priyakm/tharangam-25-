...
const Score = () => {
  const scores = [
    ...
    { position: 5, department: "Electrical Engineering", points: 30 },
    { position: 6, department: "Mechanical Engineering", points: 28 },
    { position: 7, department: "Architecture", points: 21 },
    { position: 8, department: "MBA", points: 10 },
